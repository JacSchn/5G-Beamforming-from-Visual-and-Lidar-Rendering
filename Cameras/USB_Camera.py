...
def ReturnImageMap():
    ...
    cap = cv2.VideoCapture(f'v4l2src device/dev/video1 io-mode=2 ! image/jpeg, width=(int)1280, height=(int)720 ! nvjpegdec ! video/x-raw, format=I420 ! appsink', cv2.CAP_GSTREAMER)
    if cap.isOpened():
