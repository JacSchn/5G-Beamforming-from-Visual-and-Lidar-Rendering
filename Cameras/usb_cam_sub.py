...
class FileCount:
    file_cnt = len(os.listdir('/home/musk/data/USB_CAM'))
...
def listener():
    rospy.init_node('USBcam_data_sub', anonymous=True)
    rospy.Subscriber('USBcam_data_time', String, time_callback, callback_args=(CameraTimeStamp))
    rospy.Subscriber('USBcam_data', numpy_msg(Floats), callback, callback_args=(FileCount,CameraTimeStamp))
